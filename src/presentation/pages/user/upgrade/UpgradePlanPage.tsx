...
export default function UpgradePlanPage() {
  ...
  const getAvailablePlans = container.get<GetAvailablePlansUseCase>(
    TYPES.GetAvailablePlansUseCase
  );
  // const upgradeToPlan = container.get<UpgradePlanUseCase>(
  //   TYPES.UpgradePlanUseCase
  // );
  useEffect(() => {
    getAvailablePlans
      .execute()
