...
import { loginUser } from "@/frameworks/ui/redux/slices/authSlice";
import type { AppDispatch, RootState } from "@/frameworks/ui//redux/store";
import { Eye, EyeOff, AlertCircle, Loader2 } from "lucide-react";
import { Formik, Form, Field, ErrorMessage } from "formik";
import { loginSchema } from "@/frameworks/ui/zod/loginSchema";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center rounded-xl  bg-purple-400 from-blue-50 via-indigo-50 to-purple-50 p-4">
