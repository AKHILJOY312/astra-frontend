...
import type { CreateTaskRequest, SearchMembersRequest, SearchMembersResponse, TaskAttachmentUploadRequest, TaskAttachmentUploadResponse, UpdateTaskStatusRequest } from "@/types";
import api from "./api";
import { API_ROUTES } from "./apiRoutes.constants";

export const UserCreateTask = (projectId: string, payload: CreateTaskRequest) => {
...
// export const UserEditTask = (projectId:string,taskId:string,payload:EditTaskRequest)=>{
