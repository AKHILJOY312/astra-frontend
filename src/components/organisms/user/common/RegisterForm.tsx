...
const RegisterSchema = Yup.object().shape({
  name: Yup.string()
    ...
    .max(15, "Maximum length of the name should not be greater than 15")
...
const RegisterForm: React.FC = () => {
  ...
  // Password strength calculation (outside Formik for real-time feedback)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-purple-300 bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 p-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          {/* Header */}
          <div className="text-center space-y-2">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-linear-to-br from-blue-500 to-indigo-600 rounded-full mb-2">
                  ...
                  return (
                    <Form className="space-y-5">
                      ...
                      <button
                        ...
                        className="w-full bg-linear-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 focus:ring-4 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                      >
                        {loading ? (
